...
### The Basics (Modules 1-3)

What scripting is. How it works. Variables. Operators.

The foundation. Boring but essential. Get this right, and everything else is easier.

### Logic & Control (Modules 4-6)

Making decisions. Repeating actions. Organizing code.

This is where scripts get interesting. This is where you solve actual problems.

### Data & Files (Modules 7-9)

Reading input. Processing text. Working with files.

Most scripts work with data. Most data is in files. Learn this, and you can process anything.

### Professional Scripting (Modules 10-12)

Error handling. Advanced features. Modular code.

This is what separates scripts from good scripts. This is what makes scripts maintainable.

### Automation (Modules 13-16)

Real automation. CI/CD integration. Best practices. Complete projects.

This is where it all comes together. This is where you build systems that save hours every day.
...
Begin with [What is Shell Scripting?](/docs/shell-scripting/fundamentals/what-is-shell-scripting). We'll write your first script. It'll be simple. But it'll work.
